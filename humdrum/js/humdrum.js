...
var Humdrum = (function (hd) {
    ...
    hd.Template = function() {
		 ...
		 *
		 * @param {string} source  The URL of the templates.
		 */
		...
		this.init = function(source) {
			loadTemplate(source, hd.Subscriber(this, function() {
				Object.getOwnPropertyNames(templateCache).forEach(hd.Subscriber(this, function(name) {
