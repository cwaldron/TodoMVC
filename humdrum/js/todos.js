...
/* globals console, Humdrum, TodoStore, TodoView */
...
function Todos() {
    ...
    var subscribers = {
         ...
         */
        todoAdd: Humdrum.Subscriber(this, function (title) {
         ...
         */
        todoEdit: Humdrum.Subscriber(this, function (id) {
         ...
         */
        todoEditSave: Humdrum.Subscriber(this, function (id, title) {
            if (title.length !== 0) {
         ...
         */
        todoEditCancel: Humdrum.Subscriber(this, function (id) {
            store.find(id, function (results) {
         ...
         * storage
         */
        todoRemove: Humdrum.Subscriber(this, function (id, silent) {
         ...
         */
        todoRemoveCompleted: Humdrum.Subscriber(this, function () {
            store.find({ completed: true }, function (results) {
         ...
         */
        todoToggle: Humdrum.Subscriber(this, function (viewdata, silent) {
         ...
         */
        todoToggleAll: Humdrum.Subscriber(this, function (completed) {
